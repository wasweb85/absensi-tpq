...
class GenerateLaporan extends BaseController
{
   ...
   public function generateLaporanSiswa()
   {
      ...
      foreach ($period as $value) {
         ...
         // 2. Cek apakah hari ini JUMAT? ('Fri')
         // Format 'D' menghasilkan: Mon, Tue, Wed, Thu, Fri, Sat, Sun
         $isLibur = ($value->format('D') == 'Fri'); 
   ...
   public function generateLaporanGuru()
   {
      ...
      // }
      foreach ($period as $value) {
         // 1. Tentukan Hari Libur (Jumat)
         // Jika ingin Sabtu/Minggu libur juga, tambahkan logika OR (||) di sini
         $isLibur = ($value->format('D') == 'Fri'); 
