...
class KelasController extends BaseController
{
    ...
    public function tambahKelasPost()
    {
        ...
        $val->setRule('jilid', 'Jilid', 'required|max_length[10]');
        $val->setRule('kategori', 'Kategori', 'required|in_list[Campur,Putra,Putri]');
        $val->setRule('index_kelas', 'Index', 'permit_empty|max_length[5]');
