               ...
               <div class="card-body">
                  ...
                  <div class="row align-items-center justify-content-between mb-2">
                     ...
                     <div class="col-auto">
                        ...
                        <div class="pt-3 pl-3 d-flex align-items-center">

                           <div class="mr-3">

                              <h4 class="mb-0 mt-0"><b>Daftar Kelas</b></h4>

                              <p class="mb-0 d-none d-sm-block" style="font-size: 11px;">Silakan pilih kelas</p>

                           </div>

                           <div class="ml-2">

                              <input class="form-control font-weight-bold text-primary" type="date" name="tangal" id="tanggal" value="<?= date('Y-m-d'); ?>" onchange="onDateChange()" style="max-width: 150px; font-size: 13px; height: 35px; padding: 5px;">
