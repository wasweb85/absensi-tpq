               ...
               <div class="col-12 col-xl-12">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row mb-3 pt-2 px-3">

                           <div class="col-md-4">

                              <div class="form-group mb-0">

                                 <label class="bmd-label-floating text-primary" style="font-size: 14px; position: initial; margin-bottom: 5px;">Cari Guru (Nama/NUPTK)</label>

                                 <input type="text" id="filterSearchGuru" class="form-control" placeholder="Ketik nama atau NUPTK...">
...
<script>
   ...
   $('#filterSearchGuru').on('keyup', function () {
   ...
   function getDataGuru(_search = null) {
