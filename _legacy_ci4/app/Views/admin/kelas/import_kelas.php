                                ...
                                <div class="nav-tabs-navigation">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-5">
                                            ...
                                            <h4 class="card-title"><b>Import Kelas</b></h4>

                                            <p class="card-category">Import data kelas dari CSV</p>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="csv_upload_spinner" class="csv-upload-spinner">
                                                ...
                                                <strong class="text-csv-importing">Importing Kelas...</strong>
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('admin/kelas/downloadCSVFilePost'); ?>" method="post">
                                    ...
                                    <button class="btn btn-success btn-block" name="submit"
                                        ...
                                        value="csv_kelas_template">Download Template CSV</button>
                ...
                success: function (response) {
                    ...
                    if (objSub.result == 1) {
                        ...
                        if (objSub.status == 'duplicate') {
                            ...
                            $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-warning">&nbsp;' + objSub.index + '.&nbsp; - ' + objSub.kelas.jilid + ' ' + objSub.kelas.kategori + ' ' + objSub.kelas.index_kelas + ' (Sudah Ada)</li>');

                        } else {

                            $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-success">&nbsp;' + objSub.index + '.&nbsp; - ' + objSub.kelas.jilid + ' ' + objSub.kelas.kategori + ' ' + objSub.kelas.index_kelas + '</li>');
