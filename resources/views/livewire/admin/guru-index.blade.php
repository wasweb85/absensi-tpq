                    ...
                    <div class="modal-body" style="padding: 24px; background: #fff;">
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                <label style="font-size: 0.82rem; font-weight: 600; color: #334155; margin-bottom: 6px; display: block;">NUPTK / NIP <span class="text-danger">*</span></label>
                                <input type="text" wire:model="nuptk" class="form-control" style="border-radius: 8px; border: 1px solid #cbd5e1; padding: 9px 12px; font-size: 0.9rem;" required minlength="5" maxlength="30" placeholder="Masukkan NUPTK / NIP">
                                @error('nuptk') <span class="text-danger" style="font-size: 0.78rem;">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-6 form-group mb-3">
