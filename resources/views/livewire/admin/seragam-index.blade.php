<div class="content">
                        ...
                        <div class="card">
                                ...
                                <div class="nav-tabs-navigation">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <h4 class="card-title"><b>Data Seragam</b></h4>
                                            <p class="card-category">Manajemen Seragam TPQ</p>
                                        </div>
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @forelse($seragamList as $index => $item)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td><b>{{ $item->hari }}</b></td>
                                                ...
                                                <td>
                                                    <button wire:click="edit({{ $item->id_seragam }})" class="btn btn-primary p-2">
                                                        <i class="material-icons">edit</i>
                                                    </button>
                                                    <button wire:click="deleteId({{ $item->id_seragam }})" class="btn btn-danger p-2">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center">Belum ada data seragam</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
            ...
            <div class="modal-content">
                <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $isEdit ? 'Edit Seragam' : 'Tambah Seragam' }}</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" wire:model="nama_seragam" class="form-control" required>
                                @error('nama_seragam') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Deskripsi (Opsional)</label>
                                <textarea wire:model="deskripsi" class="form-control" rows="2"></textarea>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Hapus Seragam</h5>
                    <button type="button" class="close" data-dismiss="modal">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data seragam ini?
                </div>
                <div class="modal-footer">
