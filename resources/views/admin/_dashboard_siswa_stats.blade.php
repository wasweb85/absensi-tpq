<div class="px-3 pt-2 pb-2">
    <div class="row text-center m-0 flex-nowrap align-items-center">
        <div class="col-3 px-1">
            ...
            <h4 class="text-dark font-weight-bold m-0" style="font-size: 20px; line-height: 1;">{{ $hadir }}</h4>
        </div>
        <div class="col-3 px-1">
            <h5 class="text-nowrap m-0 pb-1" style="color: #9333ea; font-size: 10px; font-weight: 800; letter-spacing: 1px;">SAKIT</h5>
            <h4 class="text-dark font-weight-bold m-0" style="font-size: 20px; line-height: 1;">{{ $sakit }}</h4>
        </div>
        <div class="col-3 px-1">
            <h5 class="text-nowrap m-0 pb-1" style="color: #2563eb; font-size: 10px; font-weight: 800; letter-spacing: 1px;">IZIN</h5>
            <h4 class="text-dark font-weight-bold m-0" style="font-size: 20px; line-height: 1;">{{ $izin }}</h4>
        </div>
        <div class="col-3 px-1">
            <h5 class="text-nowrap m-0 pb-1" style="color: #dc2626; font-size: 10px; font-weight: 800; letter-spacing: 1px;">ALFA</h5>
            <h4 class="text-dark font-weight-bold m-0" style="font-size: 20px; line-height: 1;">{{ $alfa }}</h4>
        </div>
    </div>
</div>
<div class="bg-transparent py-2 px-3 d-flex justify-content-between align-items-center" style="border-top: 1px solid #f1f5f9 !important;">
    <span class="text-muted font-weight-bold m-0" style="font-size: 10px; letter-spacing: 1px; text-transform: uppercase;">TOTAL PARTISIPASI</span>
    <span class="text-dark font-weight-bold m-0" style="font-size: 12px; line-height: 1;">{{ $totalSiswa }} Siswa</span>
</div>
