@extends('layouts.admin', ['title' => 'Backup & Restore', 'ctx' => 'backup'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <a href="{{ url('admin/backup/db/backup') }}" class="btn btn-primary">
                        ...
                        <div>
                            ...
                            <form action="{{ url('admin/backup/db/restore') }}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <a href="{{ url('admin/backup/photos/backup') }}" class="btn btn-info">
                                <i class="material-icons">cloud_download</i> Download Backup
                            </a>
                        </div>
                        <hr>
                        <div>
                            ...
                            <form action="{{ url('admin/backup/photos/restore') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Pilih file</label>
